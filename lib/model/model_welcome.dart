...
//
//     final couseFirst = couseFirstFromJson(jsonString);

import 'dart:convert';

List<CouseFirst> couseFirstFromJson(String str) => List<CouseFirst>.from(json.decode(str).map((x) => CouseFirst.fromJson(x)));

String couseFirstToJson(List<CouseFirst> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CouseFirst {
    CouseFirst({
        ...
        this.isFreeCourse,
        required this.couseFirstExternal,
    ...
    factory CouseFirst.fromJson(Map<String, dynamic> json) => CouseFirst(
        id: json["id"],
        title: json["title"],
        ...
        couseFirstExternal: json["external"],
