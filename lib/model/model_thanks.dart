...
//
//     final courseSecond = courseSecondFromJson(jsonString);

import 'dart:convert';

List<CourseSecond> courseSecondFromJson(String str) => List<CourseSecond>.from(json.decode(str).map((x) => CourseSecond.fromJson(x)));

String courseSecondToJson(List<CourseSecond> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CourseSecond {
    ...
    factory CourseSecond.fromJson(Map<String, dynamic> json) => CourseSecond(
        id: json["id"],
        code: json["code"],
        name: json["name"],
        parent: json["parent"],
